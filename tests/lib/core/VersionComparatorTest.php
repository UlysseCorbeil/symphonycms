...
final class VersionComparatorTest extends TestCase
{
    public function testFixVersion()
    {
        ...
        $this->assertEquals('1.0.*', $vc->fixVersion('1.0.x'));
        $this->assertEquals('1.*.*', $vc->fixVersion('1.*.*'));
        $this->assertEquals('1.*.*', $vc->fixVersion('1.x.x'));
    }
    ...
    public function testLessThan()
    {
        ...
        $this->assertFalse($vc->lessThan('1.0.x'));
        $this->assertTrue($vc->lessThan('2.7.x'));
        $this->assertFalse($vc->lessThan('1.x.x'));
    ...
    public function testGreaterThan()
    {
        ...
        $this->assertTrue($vc->greaterThan('1.0.x'));
        $this->assertFalse($vc->greaterThan('2.7.x'));
        $this->assertTrue($vc->greaterThan('1.x.x'));
